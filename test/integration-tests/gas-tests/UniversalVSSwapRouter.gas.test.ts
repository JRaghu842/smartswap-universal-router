import { encodeSqrtRatioX96, FeeAmount, Pool, TickMath } from 'smartswap-v3-sdk'
import { Pair, Route as V2RouteSDK } from 'smartswap-v2-sdk'
import { Route as V3RouteSDK } from 'smartswap-v3-sdk'
import { encodePath, expandTo18Decimals } from '../shared/swapRouter02Helpers'
import { BigNumber } from 'ethers'
import { SwapRouter } from 'smartswap-router-sdk'
import {
...
import { CurrencyAmount, Percent, Token, TradeType } from 'smartswap-sdk-core'
import snapshotGasCost from 'smartswap-snapshot-gas-cost'
import { IRoute, Trade } from 'smartswap-router-sdk'
const { ethers } = hre
